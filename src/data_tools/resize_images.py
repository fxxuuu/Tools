...
def preprocess(path_list, img_root, width, height, save_folder):
    ...
    for line in path_lines:
        ...
        if line[-3:] == "jpg":
            ...
            cv.imwrite(os.path.join(save_folder, line), img, [int(cv.IMWRITE_JPEG_QUALITY), 100])
...
if __name__ == "__main__":
    ...
    resize(args.path_list, args.img_root, args.width, args.height, args.save_folder)