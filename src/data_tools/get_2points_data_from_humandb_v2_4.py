            ...
            if write_signal:
                ...
                for rect in Rects:
                    ...
                    if score == 0:
                        ...
                        shoulder_x1 = rect.get('points_4')[0]['x']
                        shoulder_y1 = rect.get('points_4')[0]['y']
                        shoulder_v1 = rect.get('points_4')[0]['v']
                        if shoulder_v1 == 0:
                            point_num_0 += 1
                        elif shoulder_v1 == 1:
                            point_num_1 += 1
                        ...
                        shoulder_x2 = rect.get('points_4')[1]['x']
                        shoulder_y2 = rect.get('points_4')[1]['y']
                        shoulder_v2 = rect.get('points_4')[1]['v']
                        if shoulder_v2 == 0:
                            point_num_0 += 1
                        elif shoulder_v2 == 1:
                            point_num_1 += 1
                        ...
                        waist_x1 = rect.get('points_4')[2]['x']
                        waist_y1 = rect.get('points_4')[2]['y']
                        waist_v1 = rect.get('points_4')[2]['v']
                        if waist_v1 == 0:
                            point_num_0 += 1
                        elif waist_v1 == 1:
                            point_num_1 += 1
                        ...
                        waist_x2 = rect.get('points_4')[3]['x']
                        waist_y2 = rect.get('points_4')[3]['y']
                        waist_v2 = rect.get('points_4')[3]['v']
                        if waist_v2 == 0:
                            point_num_0 += 1
                        elif waist_v2 == 1:
                            point_num_1 += 1
                    ...
                    # 		" {} {} {} {} {}".format(x1, y1, x2, y2, score))  # write to the human_format file
                    f2.write(
                        ' {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}'.format(x1, y1, x2, y2, score, shoulder_x1,
                                                                                     shoulder_y1, shoulder_x2,
                                                                                     shoulder_y2, waist_x1, waist_y1,
                                                                                     waist_x2,
                                                                                     waist_y2, shoulder_v1, shoulder_v2,
                                                                                     waist_v1, waist_v2)
                    )
                # hf_fw_new.write('\n')
                # hf_fw_fixed.write('\n')
