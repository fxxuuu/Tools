...
with open('/home/fangxin/Fisheye/train_annotations/new_minibatch_100w_path.list','r')as f:
...
# Save Folder
save_folder = '/home/fangxin/Fisheye/train_annotations/'
if not os.path.exists(save_folder):
    os.makedirs(save_folder)
total_cnt = len(md5_list)

wh_fw = open(save_folder + '/' + str(total_cnt) + '_minibatch_Fisheye_.wh', 'w')
hf_fw = open(save_folder + '/' + str(total_cnt) + '_minibatch_Fisheye_.hf', 'w')
path_fw = open(save_folder + '/' + str(total_cnt) + '_minibatch_Fisheye_.list', 'w')
