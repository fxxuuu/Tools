...
if __name__ == '__main__':
    ...
    file_name = 'human_2points_upground_v2_from4'

    f1 = open(os.path.join(save_folder, file_name + '.md5'), 'w')
    f2 = open(os.path.join(save_folder, file_name + '.hf'), 'w')
    f3 = open(os.path.join(save_folder, file_name + '.wh'), 'w')
    ...
    for doc in docs:
        ...
        if (Rects):
            ...
            for rect in Rects:
                ## for trainset
                # if rect['v'] == 2 and ('points_4' not in rect.keys() or len(rect['points_4']) != 4):
                ## for testset
                if rect['v'] == 2 and ('points' not in rect.keys() or len(rect['points']) != 4):
                    write_signal = 0
                    break
            ...
            if write_signal:
                ...
                for rect in Rects:
                    ...
                    if score == 0:
                        ...
                        shoulder_x1 = shoulder_y1 = shoulder_v1 = 0
                        shoulder_x2 = shoulder_y2 = shoulder_v2 = 0
                        ...
                        shoulder_x1 = rect.get('points')[0]['x']
                        shoulder_y1 = rect.get('points')[0]['y']
                        shoulder_v1 = rect.get('points')[0]['v']
                        if shoulder_v1 == 0:
                            point_num_0 += 1
                        elif shoulder_v1 == 1:
                            point_num_1 += 1
                        ...
                        shoulder_x2 = rect.get('points')[1]['x']
                        shoulder_y2 = rect.get('points')[1]['y']
                        shoulder_v2 = rect.get('points')[1]['v']
                        if shoulder_v2 == 0:
                            point_num_0 += 1
                        elif shoulder_v2 == 1:
                            point_num_1 += 1
                        ...
                        waist_x1 = rect.get('points')[2]['x']
                        waist_y1 = rect.get('points')[2]['y']
                        waist_v1 = rect.get('points')[2]['v']
                        if waist_v1 == 0:
                            point_num_0 += 1
                        elif waist_v1 == 1:
                            point_num_1 += 1
                        ...
                        waist_x2 = rect.get('points')[3]['x']
                        waist_y2 = rect.get('points')[3]['y']
                        waist_v2 = rect.get('points')[3]['v']
                        if waist_v2 == 0:
                            point_num_0 += 1
                        elif waist_v2 == 1:
                            point_num_1 += 1
                    ...
                    f2.write(
                        ' {} {} {} {} {} {} {} {} {}'.format(x1, y1, x2, y2, score, shoulder_x,
                                                                                     shoulder_y, waist_x, waist_y)
                    )
                # hf_fw_new.write('\n')
                # hf_fw_fixed.write('\n')
                f2.write('\n')
    ...
    print '\nThe point number for value 0, 1, and 2 are {}, {} and {}'.format(point_num_0, point_num_1, point_num_2)
    print '{} annotations are written in {}'.format(img_cnt, os.path.join(save_folder, file_name))